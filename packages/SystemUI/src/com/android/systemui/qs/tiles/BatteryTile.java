...
public class BatteryTile extends QSTile<QSTile.State> implements BatteryController.BatteryStateChangeCallback {
    ...
    public BatteryTile(Host host) {
        ...
        mBatteryStyleTile = CMSettings.System.getInt(host.getContext().getContentResolver(),
                CMSettings.System.STATUS_BAR_BATTERY_STYLE_TILE, 1);
        ...
        state.icon = new Icon() {
            ...
            public Drawable getDrawable(Context context) {
                mBatteryStyle = CMSettings.System.getInt(context.getContentResolver(),
                        CMSettings.System.STATUS_BAR_BATTERY_STYLE, 0);
                mBatteryStyleTile = CMSettings.System.getInt(context.getContentResolver(),
                        CMSettings.System.STATUS_BAR_BATTERY_STYLE_TILE, 1);
                if (mBatteryStyle == BATTERY_STYLE_HIDDEN || mBatteryStyle == BATTERY_STYLE_TEXT || mBatteryStyleTile == 0) {
                    mBatteryStyle = 0;
                }
